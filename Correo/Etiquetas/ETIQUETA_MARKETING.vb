...
Public Class ETIQUETA_MARKETING
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Correo.ETIQUETA_MARKETING.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedETIQUETA_MARKETING
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ETIQUETA_MARKETING = New ETIQUETA_MARKETING()
        rpt.Site = Me.Site
        Return rpt
    End Function
