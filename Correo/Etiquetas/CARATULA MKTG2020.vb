...
Public Class CARATULA_MKTG2020
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Correo.CARATULA MKTG2020.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCARATULA_MKTG2020
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CARATULA_MKTG2020 = New CARATULA_MKTG2020()
        rpt.Site = Me.Site
        Return rpt
    End Function
