...
Public Class AR_MKTG2020__sin_detalle
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "AR MKTG2020  sin detalle.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Correo.AR MKTG2020  sin detalle.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAR_MKTG2020__sin_detalle
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AR_MKTG2020__sin_detalle = New AR_MKTG2020__sin_detalle()
        rpt.Site = Me.Site
        Return rpt
    End Function
