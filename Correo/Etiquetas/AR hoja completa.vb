...
Public Class AR_hoja_completa
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Correo.AR hoja completa.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedAR_hoja_completa
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As AR_hoja_completa = New AR_hoja_completa()
        rpt.Site = Me.Site
        Return rpt
    End Function
