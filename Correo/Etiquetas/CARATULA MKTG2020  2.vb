...
Public Class CARATULA_MKTG2020__2
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "CARATULA MKTG2020  2.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Correo.CARATULA MKTG2020  2.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedCARATULA_MKTG2020__2
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As CARATULA_MKTG2020__2 = New CARATULA_MKTG2020__2()
        rpt.Site = Me.Site
        Return rpt
    End Function
