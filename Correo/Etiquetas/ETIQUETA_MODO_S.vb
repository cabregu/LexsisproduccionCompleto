...
Public Class ETIQUETA_MODO_S
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Correo.ETIQUETA_MODO_S.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedETIQUETA_MODO_S
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ETIQUETA_MODO_S = New ETIQUETA_MODO_S()
        rpt.Site = Me.Site
        Return rpt
    End Function
