...
Public Class ACUSE_FACT_EMPRESA
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Correo.ACUSE_FACT-EMPRESA.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedACUSE_FACT_EMPRESA
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ACUSE_FACT_EMPRESA = New ACUSE_FACT_EMPRESA()
        rpt.Site = Me.Site
        Return rpt
    End Function
