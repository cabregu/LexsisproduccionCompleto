...
Public Class ACUSE_MARKETING
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Correo.ACUSE_MARKETING.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedACUSE_MARKETING
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ACUSE_MARKETING = New ACUSE_MARKETING()
        rpt.Site = Me.Site
        Return rpt
    End Function
